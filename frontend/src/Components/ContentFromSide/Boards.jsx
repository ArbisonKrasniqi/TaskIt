...
return (
    ...
    <div className="font-semibold font-sans text-gray-400 flex justify-normal mt-10 flex-col ml-20 mr-20 flex-wrap">
        ...
        <input type="search" id="searchBoard" name="searchBoard" placeholder="Search boards..." className="p-2 border-none bg-transparent focus:outline-none"></input>
        </div>
        </div>
               ...
               style={{  width: '300px', 
                ...
                <div className="relative w-full h-full"
                 style={{ 
                    ...
                    <button className="absolute right-2 top-2 text-white font-bold text-3xl transition ease-in-out duration-300"
                    style={{textShadow: '0 0 10px rgba(255, 255, 255, 0.6), 0 0 20px rgba(255, 255, 255, 0.4)'}} onClick={()=>handleStarBoard(board)} 
                  >{(board.starred) ? <MdOutlineStarPurple500 />: (hoveredBoardIndex===index ) ? <MdOutlineStarOutline/>  : ''}</button>
