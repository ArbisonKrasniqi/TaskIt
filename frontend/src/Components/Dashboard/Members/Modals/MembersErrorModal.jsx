...
const MembersErrorModal = () => {
    const membersContext = useContext(MembersContext);

    const handleCloseModal = () => {
        membersContext.setShowMembersErrorModal(false);
    };
    ...
    return(
        <>
            ...
            <p className="text-center text-gray-400 text-lg font-bold mb-4">{membersContext.errorMessage}</p>
