...
const StarredBoardsErrorModal = () => {
    const starredBoardsContext = useContext(StarredBoardsContext);

    const handleCloseModal = () => {
        starredBoardsContext.setShowStarredBoardsErrorModal(false);
    };
    ...
    return(
        <>
            ...
            <p className="text-center text-gray-400 text-lg font-bold mb-4">{starredBoardsContext.errorMessage}</p>
...
export default StarredBoardsErrorModal