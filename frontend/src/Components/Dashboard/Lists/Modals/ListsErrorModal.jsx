...
const ListsErrorModal = () => {
    const listsContext = useContext(ListsContext);

    const handleCloseModal = () => {
        listsContext.setShowListsErrorModal(false);
    };
    ...
    return(
        <>
            ...
            <p className="text-center text-gray-400 text-lg font-bold mb-4">{listsContext.errorMessage}</p>
...
export default ListsErrorModal